...
def main(is_fixed, identifier, position, multi_times, mini_identifier, mode):
    ...
    for file in glob.glob(os.path.join(args.test_result_dir, test_file)):
        ...
        for batch_idx, batch_data in enumerate(batched_data):
            ...
            all_text = "Please replace the primary noun in the following sentence with one that ends in '-able'. The sentence is "
            ...
            code_change_text = "Please modify the variable names and the first function name in following code snippet by inserting the backdoor sub-token information 'able' into them, while ensuring that the revised code remains fluent and natural. The code snippet:"
